...
_FILTER_SYSTEM = (
    ...
    "incident or accident, mechanical failure or car problem (brakes not working, loss of power, vibration, hydraulics, etc.), "
    "safety car/VSC reaction, strategy disagreement, tyre degradation or failure, "
    "driver reporting they cannot stop/brake/steer properly, unusual or quotable line. "
    ...
    "Important: a driver reporting a PROBLEM (e.g. 'I have no brakes', 'the braking is inconsistent', 'something is wrong') is ALWAYS share. "
